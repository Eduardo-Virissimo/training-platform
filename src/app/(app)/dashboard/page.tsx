...
export default async function DashboardPage() {
  ...
  return (
    <div className="bg-white/10 backdrop-blur-lg border border-white/20 rounded-2xl p-8">
      <h2 className="text-2xl font-bold text-white mb-2">Olá, {session.name.split(' ')[0]}!</h2>
      <p className="text-purple-200 mb-6">Você está logado na plataforma de treinamentos.</p>
